...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FunkinStudios", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FunkinStudios", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "5576";
		app.meta["company"] = "HenryCodesFnF";
		app.meta["file"] = "FunkinStudios";
		app.meta["name"] = "FunkinStudios";
		app.meta["packageName"] = "com.HenryCodesFnF.FunkinStudios";
